...
},{"../tools/Pencil":34,"./actions":3,"./bindEvents":4,"./math":7,"./shapes":8,"./util":9}],3:[function(_dereq_,module,exports){
...
defineShape = function(name, props) {
  var Shape, k;
  Shape = function(argsObj) {
    props.constructor.call(this, argsObj);
    if (!argsObj) {
      argsObj = {};
    }
    this.customData = argsObj.customData || {};
    return this;
  };
...
tools = {
  ...
  Dot: _dereq_('./tools/Dot'),
  AreaSelect: _dereq_('./tools/AreaSelect'),
...
init = function(el, opts) {
  var child, drawingViewElement, lc, pickerElement, _i, _len, _ref;
  if (opts == null) {
    opts = {};
  }
...
},{"./core/LiterallyCanvas":2,"./core/localization":6,"./core/shapes":8,"./core/util":9,"./optionsStyles/font":11,"./optionsStyles/line-options-and-stroke-width":12,"./optionsStyles/null":13,"./optionsStyles/optionsStyles":14,"./optionsStyles/stroke-width":15,"./reactGUI/init":26,"./tools/AreaSelect":27,"./tools/Dot":28,"./tools/Ellipse":29,"./tools/Eraser":30,"./tools/Eyedropper":31,"./tools/Line":32,"./tools/Pan":33,"./tools/Pencil":34,"./tools/Rectangle":35,"./tools/Text":36,"./tools/base":37}],11:[function(_dereq_,module,exports){
...
Picker = React.createClass({
  ...
  render: function() {
    var imageURLPrefix, lc, toolButtonComponents, ul, _ref;
    ul = React.DOM.ul;
...
createToolButton = function(_arg) {
  ...
  return React.createClass({
    ...
    render: function() {
      var className, imageURLPrefix, img, isSelected, li, onSelect, span, _ref, _ref1;
      _ref = React.DOM, li = _ref.li, img = _ref.img, span = _ref.span;
...
init = function(pickerElement, lc, tools, imageURLPrefix) {
  ...
  return React.renderComponent(Picker({
    lc: lc,
...
var AreaSelect, ToolWithStroke, createShape,
...
module.exports = AreaSelect = (function(_super) {
  __extends(AreaSelect, _super);

  AreaSelect.prototype.name = 'Area';

  AreaSelect.prototype.iconName = 'bucket';

  function AreaSelect() {
    this.strokeWidth = 10;
  }

  AreaSelect.prototype.optionsStyle = 'stroke-width';

  AreaSelect.prototype.isPointInPath = function(x, y, points) {
    var i, is_in_path, j, _i, _ref;
    j = points.length - 1;
    is_in_path = false;
  ...
  AreaSelect.prototype.begin = function(x, y, lc) {
    var backgroundShape, removedShape, shape, _i, _j, _len, _len1, _ref, _ref1, _results;
    _ref = lc.backgroundShapes;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      backgroundShape = _ref[_i];
      if (!(backgroundShape.customData.isAreaSelection && this.isPointInPath(x, y, backgroundShape.points))) {
        continue;
      }
      removedShape = lc.backgroundShapes.splice(lc.backgroundShapes.indexOf(backgroundShape), 1)[0];
      lc.trigger('shapeSave', {
        shape: removedShape
      });
    ...
    _ref1 = lc.backgroundShapes;
    _results = [];
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      backgroundShape = _ref1[_j];
      if (this.isPointInPath(x, y, backgroundShape.points)) {
        ...
        lc.trigger('drawingChange');
        _results.push(lc.repaintLayer('background'));
      } else {
  ...
  AreaSelect.prototype["continue"] = function(x, y, lc) {};

  AreaSelect.prototype.end = function(x, y, lc) {};
...
},{"../core/shapes":8,"./base":37}],28:[function(_dereq_,module,exports){
var Dot, ToolWithStroke, createShape,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = Dot = (function(_super) {
  ...
  Dot.prototype.iconName = 'dot';

  function Dot() {
    this.strokeWidth = 10;
  }

  Dot.prototype.optionsStyle = 'stroke-width';

  Dot.prototype.begin = function(x, y, lc) {
    var removedShape, shape, _i, _len, _ref;
    this.removal = false;
    _ref = lc.shapes;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      shape = _ref[_i];
      if (shape && shape.customData.isDot) {
  ...
  Dot.prototype["continue"] = function(x, y, lc) {
    if (!this.removal) {
  ...
  Dot.prototype.end = function(x, y, lc) {
    if (!this.removal) {
...
},{"../core/shapes":8,"./base":37}],29:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./base":37}],30:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./Pencil":34}],31:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./base":37}],32:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./base":37}],33:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./base":37}],34:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./base":37}],35:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./base":37}],36:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./base":37}],37:[function(_dereq_,module,exports){
