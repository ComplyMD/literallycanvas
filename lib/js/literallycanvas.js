...
linePathFuncs = {
  constructor: function(args) {
    ...
    this.fillColor = args.fillColor || "rgba(255, 255, 255, 0.0)";
...
tools = {
  ...
  PathFill: _dereq_('./tools/PathFill'),
...
},{"./core/LiterallyCanvas":2,"./core/localization":6,"./core/shapes":8,"./core/util":9,"./optionsStyles/font":11,"./optionsStyles/line-options-and-stroke-width":12,"./optionsStyles/null":13,"./optionsStyles/optionsStyles":14,"./optionsStyles/stroke-width":15,"./reactGUI/init":26,"./tools/Dot":27,"./tools/Ellipse":28,"./tools/Eraser":29,"./tools/Eyedropper":30,"./tools/Line":31,"./tools/Pan":32,"./tools/PathFill":33,"./tools/Pencil":34,"./tools/Rectangle":35,"./tools/Text":36,"./tools/base":37}],11:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./Pencil":34}],30:[function(_dereq_,module,exports){
...
},{"../core/shapes":8,"./base":37}],31:[function(_dereq_,module,exports){
...
var PathFill, ToolWithStroke, createShape,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = PathFill = (function(_super) {
  __extends(PathFill, _super);

  PathFill.prototype.name = 'PathFill';

  PathFill.prototype.iconName = 'pathfill';

  function PathFill() {
    this.strokeWidth = 1;
  }

  PathFill.prototype.optionsStyle = 'stroke-width';

  PathFill.prototype.isPointInPath = function(x, y, points) {
  ...
  PathFill.prototype.begin = function(x, y, lc) {
    var backgroundShape, bgShape, pair, points, _fn, _i, _j, _len, _len1, _ref, _ref1, _results;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (this.isPointInPath(x, y, backgroundShape.points)) {
        points = [];
        _ref1 = backgroundShape.points;
        _fn = function(pair) {
          return points.push(createShape('Point', {
            x: pair.x,
            y: pair.y,
            size: 1,
            color: '#000'
        ...
        this.shapeMask = createShape('LinePath', {
          points: points,
          tailSize: 0,
          order: 1,
          interpolate: false,
        ...
        this.shapeMask.background = true;
        bgShape = createShape('LinePath', {
          points: points,
          tailSize: 0,
          order: 1,
          interpolate: false,
        ...
        _results.push(lc.saveShape(this.shapeMask));
      } else {
  ...
  PathFill.prototype["continue"] = function(x, y, lc) {};

  PathFill.prototype.end = function(x, y, lc) {};
